...
@Component
public class PublicarseAEstadistica {
  ...
  public PublicarseAEstadistica(RestTemplate rest,
                                Environment env,
                                @Value("${M.Estadistica.Publicarse.url}") String registryEndpoint) {
    this.rest = rest;
    this.env = env;
  ...
  public void onWebServerReady(WebServerInitializedEvent event) {
    ...
    Map<String, Object> payload = Map.of(
            "UrlBase", baseUrl,
            "endpointSolicitudesEliminacion", "/api-agregador/solicitudesEliminacion",
            "enpointHechos", "/api-agregador/hechos",
            "endpointColecciones", "/api-colecciones/colecciones"
    );
