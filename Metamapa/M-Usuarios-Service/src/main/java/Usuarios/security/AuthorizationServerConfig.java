...
public class AuthorizationServerConfig {
  ...
  public RegisteredClientRepository registeredClientRepository() {
    RegisteredClient metamapaClient = RegisteredClient.withId(UUID.randomUUID().toString())
            ...
            .redirectUri("http://ec2-18-206-12-169.compute-1.amazonaws.com:9000/callback")
            .redirectUri("http://ec2-18-206-12-169.compute-1.amazonaws.com:9000/authorized") // Otra posible URI de callback
